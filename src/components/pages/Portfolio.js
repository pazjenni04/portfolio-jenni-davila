...
const projects = [
  {
    ...
    stillPNG: "../../images/community-sidekicks.png",
  ...
  },
  {
    ...
    stillPNG: "../../images/fitness-tracker.png",
  ...
  },
  {
    ...
    stillPNG: "../../images/company-directory.png",
          ...
          <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            {projects.map((prop) => (
              <Card
                ...
                stillPNG={prop.stillPNG}
                appLink={prop.appLink}
                Github={prop.Github}
                tech={prop.tech}
                key={prop.id}
              />
